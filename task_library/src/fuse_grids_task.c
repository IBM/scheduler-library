...
//  vehicle_state_t vehicle_state) {
  ...
  if (use_auto_finish) {
    fuse_grids_mb_ptr->atFinish = (void (*)(struct task_metadata_entry_struct *))(sptr->auto_finish_task_function[fuse_grids_task_type]); // get_auto_finish_routine(sptr, fuse_grids_task_type);
  } else {
