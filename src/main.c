...
//   CPU      LG-FFT        SM-FFT         LG-VIT     MD-VIT     SM-VIT     LG-CV      SM-CV      NONE
  { 23000, LgFFT0*LgFFTx, LgFFT0*SmFFTx, ACINFPROF, ACINFPROF, ACINFPROF, ACINFPROF, ACINFPROF, ACINFPROF},  //  1k-sample FFT
  {600000, LgFFT1*LgFFTx, LgFFT1*SmFFTx, ACINFPROF, ACINFPROF, ACINFPROF, ACINFPROF, ACINFPROF, ACINFPROF}}; // 16k-sample FFT


// Viterbi has 4 profiles, depending on input size
uint64_t vit_profile[4][NUM_ACCEL_TYPES] = {
//    CPU        FFT      SM-FFT         VIT          MD-VIT         SM-VIT        CV        SM-CV      NONE
  { 120000,  ACINFPROF, ACINFPROF, LgVIT0*LgVITx, LgVIT0*MdVITx, LgVIT0*SmVITx, ACINFPROF, ACINFPROF, ACINFPROF},  // short-message Vit
  {1700000,  ACINFPROF, ACINFPROF, LgVIT1*LgVITx, LgVIT1*MdVITx, LgVIT1*SmVITx, ACINFPROF, ACINFPROF, ACINFPROF},  // medium-message Vit
  {3400000,  ACINFPROF, ACINFPROF, LgVIT2*LgVITx, LgVIT2*MdVITx, LgVIT2*SmVITx, ACINFPROF, ACINFPROF, ACINFPROF},  // long-message Vit
...
int main(int argc, char *argv[])
{
  ...
  printf("Run using Scheduler Policy %u with FFT %u at %u sFFT %u at %u VIT %u at %u mVIT %u at %u sVIT %u at %u CV %u at %u sCV %u at %u and hold-off %u\n",
	  global_scheduler_selection_policy, NUM_FFT_ACCEL, LgFFTx, NUM_SM_FFT_ACCEL, SmFFTx, NUM_VIT_ACCEL, LgVITx, NUM_MD_VIT_ACCEL, MdVITx, NUM_SM_VIT_ACCEL, SmVITx, NUM_CV_ACCEL, LgCVx, NUM_SM_CV_ACCEL, SmCVx, scheduler_holdoff_usec);
 #ifdef HW_FFT
