...
void scramble(const char *input, char *out, frame_param_t *frame, char initial_state);

void reset_tail_bits(char *scrambled_data, frame_param_t *frame);

void convolutional_encoding(const char *input, char *out, int n_data_bits); //frame_param_t *frame);

void puncturing(const char *input, char *out, frame_param_t *frame, ofdm_param_t *ofdm);

void interleave(const char *input, char *out, int n_sym, /*frame_param_t *frame,*/ int n_cbps, int n_bpsc, /*ofdm_param_t *ofdm,*/ bool reverse);

void split_symbols(const char *input, char *out, frame_param_t *frame, ofdm_param_t *ofdm);
