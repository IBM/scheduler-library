...
extern uint64_t sysh_total_sec;
extern uint64_t sysh_total_usec;

extern uint64_t sysh_search_sec;
extern uint64_t sysh_search_usec;

extern uint64_t sysh_frame_sec;
extern uint64_t sysh_frame_usec;
#endif
